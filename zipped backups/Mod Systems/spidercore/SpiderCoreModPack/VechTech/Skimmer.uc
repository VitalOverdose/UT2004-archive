//-----------------------------------------------------------
class Skimmer extends ONSHoverBike;
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'Vectech.bolas')
     PassengerWeapons(0)=(WeaponPawnClass=Class'onslaught.ONSPRVRearGun')
     TPCamDistance=350.000000
VehiclePositionString="in a Skimmer"
VehicleNameString="Skimmer"
}
