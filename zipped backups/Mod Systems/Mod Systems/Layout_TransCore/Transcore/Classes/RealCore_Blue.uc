//-----------------------------------------------------------
// RealCore_Blue......Links to EITHER PseudoCore OR TransCore_Blue
// By FatalOverdose 2005 (c)
// Part OF The PseudoCore Mod Package
// DigiMechTech
// http://www.FatalOverdose.copperstream.co.uk
//-----------------------------------------------------------
class RealCore_Blue extends ONSPowerCoreblue;

var  PseudoCore_Blue       My_Linked_PseudoCore;
var  TransCore_Blue        My_Linked_TransCore,SpawnedTransCore;
...
simulated function LinkRequest(optional PseudoCore_Blue MyLinked_PseudoCore,optional TransCore_Blue MyLinkedTransCore)
{
...
if (Wheretospawn==1)
   ...
   SpawnedTransCore=Spawn( class'TransCore_Blue', self,, My_Linked_PseudoCore.Location+VehicleSpawnOffSet,My_Linked_PseudoCore.rotation);
...
if (Wheretospawn==2)
   ...
   SpawnedTransCore=Spawn( class'TransCore_Blue', self,,SepecifiedVehicleSpawnPosition+VehicleSpawnOffSet,rotation);
   health=SpawnedTransCore.health;
   }
}
