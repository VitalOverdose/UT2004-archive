...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'VecTech.DaMiniBoomStick')
     PassengerWeapons(0)=(WeaponPawnClass=Class'VecTech.UltraMechTurret')
     bHasAltFire=True
     FireImpulse=(X=-5000.000000)
     DestroyEffectClass=Class'Onslaught.ONSVehicleExplosionEffect'
