...
//
//-----------------------------------------------------------
class Wyvern extends ONSAttackCraft;
...
defaultproperties
{
     ...
     PassengerWeapons(0)=(WeaponPawnClass=Class'VecTech.Mortician_Headsecond')
     bEnableProximityViewShake=True
     FireImpulse=(X=-5000.000000)
     AltFireImpulse=(X=-5000.000000)
     bCanFlip=True
     TPCamDistance=1250.000000
     VehiclePositionString="in a Wyvern"
     VehicleNameString="Wyvern"
     DrawScale=2.000000
}
